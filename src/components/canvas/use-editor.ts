      ...
      setCanvasContainerSize: (size) => {
        set((state) => {
          ...
          if (
            ...
            const zoomX = (size.width * 0.8) / nextCanvas.size.width;
            const zoomY = (size.height * 0.9) / nextCanvas.size.height;
      ...
      updateCanvasSize: (size) => {
        set((state) => {
          ...
          if (
            ...
            const zoomX = (containerSize.width * 0.8) / nextSize.width;
            const zoomY = (containerSize.height * 0.9) / nextSize.height;
            const targetZoom = Math.min(zoomX, zoomY);
